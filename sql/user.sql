...
CREATE TABLE IF NOT EXISTS `user_privacy` (
                                              `u_id` BIGINT NOT NULL COMMENT '用户UID，对应 user.u_id',
                                              `show_collect`           TINYINT NOT NULL DEFAULT 1 COMMENT '公开收藏 1是0否',
                                              `show_birthday_and_tag`  TINYINT NOT NULL DEFAULT 1 COMMENT '公开生日/标签',
                                              `show_comic`             TINYINT NOT NULL DEFAULT 1 COMMENT '公开追漫',
                                              `show_bangumi`           TINYINT NOT NULL DEFAULT 1 COMMENT '公开追番追剧',
                                              `show_school_info`       TINYINT NOT NULL DEFAULT 0 COMMENT '公开学校',
                                              `show_fans_decorate`     TINYINT NOT NULL DEFAULT 1 COMMENT '公开粉丝装扮',
                                              `show_coin_video`        TINYINT NOT NULL DEFAULT 1 COMMENT '公开最近投币',
                                              `show_game`              TINYINT NOT NULL DEFAULT 1 COMMENT '公开最近游戏',
                                              `show_live_replay`       TINYINT NOT NULL DEFAULT 1 COMMENT '投稿展示直播回放',
                                              `show_like_video`        TINYINT NOT NULL DEFAULT 1 COMMENT '公开最近点赞',
                                              `show_fans_medal`        TINYINT NOT NULL DEFAULT 1 COMMENT '公开粉丝勋章',
                                              `show_class_video`       TINYINT NOT NULL DEFAULT 1 COMMENT '投稿展示课堂',
                                              `show_follow_list`       TINYINT NOT NULL DEFAULT 1 COMMENT '公开关注列表',
                                              `show_fans_list`         TINYINT NOT NULL DEFAULT 1 COMMENT '公开粉丝列表',
                                              `show_charge_video`      TINYINT NOT NULL DEFAULT 1 COMMENT '投稿展示充电专属',
