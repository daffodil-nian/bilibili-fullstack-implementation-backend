...
public class OssJavaSdkQuickStart {
    ...
    public void testUpLoadImage() {
        ...
        // 3. 直接调用注入的 ossUtil 实例
        String objectKey = ossUtil.upLoadImage(OssImageTypeEnum.AVATAR, userId, fileName, inputStream);

        System.out.println("生成的 ObjectKey: " + objectKey);
    }
    ...
    public static void main(String[] args) throws com.aliyuncs.exceptions.ClientException {
        ...
        String bucketName = ossUtil.getBucket();
        // 填写Bucket所在地域。以华东1（杭州）为例，Region填写为cn-hangzhou。
        String region = ossUtil.getRegion();
